...
public class InsertionSortPosition  extends AlgorithmPosition{
	...
	public String getHelpMessage(AlgorithmPosition userAlgorithmPosition, boolean isSwitchSuccessful){
		...
		String startMessage = String.format(super.context.getString(R.string.insert_startMessage), this.outerLoopIndex, (this.outerLoopIndex));
        String endMessage = String.format(super.context.getString(R.string.insert_endMessage), this.outerLoopIndex);
        String copyFirstMessage = String.format(super.context.getString(R.string.insert_copyFirstMessage), (this.outerLoopIndex));
       
        String copyMessage = String.format(super.context.getString(R.string.insert_copyMessage), (super.getAlgorithmIndexI()));
